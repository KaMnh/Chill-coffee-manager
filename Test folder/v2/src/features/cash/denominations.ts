...
export function normalizeCount(value: string | number | null | undefined) {
  return Math.max(0, Number(value) || 0);
}

function focusDenominationInput(inputRefs: DenominationInputRefs, denomination: number, direction: -1 | 1) {
